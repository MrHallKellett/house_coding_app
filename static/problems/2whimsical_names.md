...
Henry wants to know if any other things are palindromes. 

## Input Format

You are given a single word as the only line of input.

## Output Format

A single character, “y” if the word is a palindrome, “n” otherwise.
